...
bot_token = "402168705:AAHl-2B6JGVUXlIPUN63rcCiMUuqdu4kwQI"
send_api = "https://api.telegram.org/bot"..bot_token
BeyondTeam = -1001114813140
sudo_id = 475975207
...
function msg_valid(msg)
 ...
 if is_silent_user(msg.from.id, msg.chat.id) then
 del_msg(msg.chat.id, tonumber(msg.message_id))
    return false
 end
 if is_banned(msg.from.id, msg.chat.id) then
 del_msg(msg.chat.id, tonumber(msg.message_id))
...
if not tostring(SUDO):match('%d+') then
  ...
  config = {
   ...
   "plugins",
    ...
    sudo_users = {475975207, 363936323,410742984},--Sudo users
    master_id = 475975207,363936323,410742984 
    admins = {},
    disabled_channels = {},
    moderation = {data = './data/moderation.json'},
    info_text = [[*》DELETE Manager V2.0*
`》An advanced administration bot based on` *BDMessenger*

》[DELETE Manager](https://github.com/irboy/DELEMG.git)

*》Admins :*
*》Founder & Developer :* [mr.irani](Telegram.Me/iranb0y)
_》Developer & Sponser :_ [pouya](Telegram.Me/)
_》Developer :_ [hasan](Telegram.Me/)
_》Developer :_ [amir](Telegram.Me/)

*》Special thanks to :*
`delete Team Members`

*》Our channel :*
》[deleteTeam](Telegram.Me/)

*》Our Site :*
[delete Team Forum](vvvvv.delete.ir)
]],
  }
